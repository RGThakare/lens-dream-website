...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="pt-24 pb-20 bg-stone-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-2xl font-light text-stone-800 mb-6">Get in Touch</h2>
              
              <div className="space-y-6">
                <div>
                  <h3 className="text-stone-700 font-medium mb-2">Email</h3>
                  <p className="text-stone-600 font-light">hello@weddinglens.com</p>
                </div>
                
                <div>
                  <h3 className="text-stone-700 font-medium mb-2">Phone</h3>
                  <p className="text-stone-600 font-light">+1 (555) 123-4567</p>
                </div>
                
                <div>
                  <h3 className="text-stone-700 font-medium mb-2">Location</h3>
                  <p className="text-stone-600 font-light">Available Nationwide</p>
                </div>
                
                <div>
                  <h3 className="text-stone-700 font-medium mb-2">Response Time</h3>
