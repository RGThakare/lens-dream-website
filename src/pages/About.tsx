...
const About = () => {
  return (
    <div className="min-h-screen">
      ...
      <section className="pt-24 pb-20 bg-stone-50 relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              <div className="mb-6">
                ...
                <p className="text-amber-600 font-light tracking-wider text-lg">आमच्याबद्दल</p>
              </div>
              ...
              <p className="text-stone-600 text-lg mb-8 leading-relaxed font-light">
                ...
                the joy of Antarpat, and every precious ritual that makes your wedding day extraordinary.
              </p>
              ...
              <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-6 rounded border-l-4 border-amber-500">
                <p className="text-stone-700 font-light italic text-center text-lg">
                  "सर्व मंगल मांगल्ये शिवे सर्वार्थ साधिके"
                </p>
                <p className="text-stone-600 text-sm text-center mt-2">
                  - Blessing every auspicious moment of your journey
                </p>
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2 relative">
              ...
              <div className="absolute -top-6 -left-6 text-amber-500 text-3xl opacity-60">
                ✨
              </div>
              <div className="absolute -top-6 -right-6 text-red-500 text-3xl opacity-60">
                🌺
              </div>
              ...
              <div className="absolute -bottom-6 -right-6 text-amber-600 text-3xl opacity-60">
                🪔
              </div>
              <div className="absolute -bottom-6 -left-6 text-red-400 text-2xl opacity-60">
                🙏
              </div>
            </div>
          </div>
